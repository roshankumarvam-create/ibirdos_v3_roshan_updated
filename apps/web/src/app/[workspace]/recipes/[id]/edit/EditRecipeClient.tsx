  ...
  return (
    <div className="space-y-6 pb-20">
      ...
      <div className={canSeeFinancials ? "grid grid-cols-1 lg:grid-cols-3 gap-6" : "grid grid-cols-1 gap-6"}>
        ...
        {/* ---- RIGHT COLUMN (cost summary) -- omitted entirely for roles
             without financial visibility, not dashed out. ---- */}
        {canSeeFinancials && (
        ...
        {/* Save button, shown standalone when the cost-summary sidebar
            (which normally carries it) is hidden. */}
        {!canSeeFinancials && (
          <Button onClick={handleSubmit} disabled={!canSubmit} loading={submitting}>
            Save changes
          </Button>
