...
// Used by the first-login flow when mustChangePassword is true. The
// current password is the admin-generated one shown once at user
// creation; the new password must meet PasswordSchema's strength rules.
